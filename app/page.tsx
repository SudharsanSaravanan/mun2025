      ...
      <div>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 bg-white">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-center text-gray-900">
                Letter from the Secretary-General
              </h2>
              <p className="text-base sm:text-lg text-gray-700 max-w-4xl mx-auto font-serif leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-end justify-center gap-8 max-w-4xl mx-auto mt-4">
                <div className="flex-1 flex flex-col items-end w-full">
                  <p className="text-base sm:text-lg text-gray-700 font-serif text-right w-full mb-2">
                    With pride and pleasure,<br /><br />
                  </p>
                  <img
                    src="images/Signature.JPG"
                    alt="Signature"
                    className="w-[180px] sm:w-[250px] md:w-[300px] h-auto mb-4 self-end"
                  />
                  <p className="text-base sm:text-lg text-gray-700 font-serif text-right w-full">
                    Shruti Sivakumar<br />
